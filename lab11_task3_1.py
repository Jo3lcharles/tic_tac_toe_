...
class Book:
    ...
    def __eq__(self, other ) -> bool:
        ...
        False
        """
        if self.get_isbn() == other.get_isbn():
            return True
        return False
...
class Library:
    ...
    def __str__(self) -> str:
        ...
        """
        return "\n".join([
            f"Title: {book.get_title()}, Author: {book.get_author()}, Year: {book.get_publication_year()}, ISBN: {book.get_isbn()}" for book in self._books
        ])
